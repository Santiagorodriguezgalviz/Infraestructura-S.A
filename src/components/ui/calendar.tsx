    ...
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          ...
          'hover:bg-primary/10 rounded-md transition-colors duration-200',
        ...
        day: cn(
          ...
          'h-8 w-8 p-0 font-normal aria-selected:opacity-100 hover:bg-transparent transition-colors duration-200'
        ),
